...
#include "GameTypes.h"
	...
	#define PERSONAL_RELATIVEGAME_PARENT _W("Hopelessness in War/")
	#define PERSONAL_RELATIVEGAME _W("Hopelessness in War/HPL1/")
	...
	#define PERSONAL_RELATIVEGAME_PARENT _W("HopelessnessInWar/")
	#define PERSONAL_RELATIVEGAME _W("HopelessnessInWar/HPL1/")
#else
